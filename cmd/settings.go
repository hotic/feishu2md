...
type MergeSettings struct {
	...
	// FilenameCSV is the markdown filename to generate by merging only CSV files found in input_dir
	FilenameCSV string `json:"filename_csv,omitempty" yaml:"filename_csv,omitempty"`
	// CSVFilename is an alias for FilenameCSV to support alternative key 'csv_filename'
	CSVFilename         string   `json:"csv_filename,omitempty" yaml:"csv_filename,omitempty"`
